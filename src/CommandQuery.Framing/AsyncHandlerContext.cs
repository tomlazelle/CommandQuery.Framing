...
/// <summary>
/// Context for asynchronous handler pipeline execution.
...
public class AsyncHandlerContext<TRequest, TResponse> : PipelineContext
    where TRequest : IMessage
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="AsyncHandlerContext{TRequest, TResponse}"/> class.
    /// </summary>
    /// <param name="request">The request message to process.</param>
    /// <param name="cancellationToken">Cancellation token for the operation.</param>
    public AsyncHandlerContext(TRequest request, CancellationToken cancellationToken = default)
    {
        Request = request;
